<div class="">
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Kategori<small>different form elements</small></h2>
	    ...
	    <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="varchar">Kode Kategori <?php echo form_error('kode_kategori') ?></label>
	    ...
	    <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="varchar">Nama Kategori <?php echo form_error('nama_kategori') ?></label>
                <div class="col-md-6 col-sm-6 col-xs-12">
	    ...
	    <a href="<?php echo site_url('kategori') ?>" class="btn btn-default"><i class="fa fa-reply-all"></i> Cancel</a>
	</div>
                        </div></form>
     </div>
            </div>
